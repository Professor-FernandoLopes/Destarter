...
class RequestNew extends Component {
  ...
  onSubmit = async event => {
    ...
    /* se tiver mais parâmetros na struct tem que adicionar aqui
    originalmente tinha um description que está comentado acima
    */
    const {  value, recipient } = this.state;
    ...
    */
      await campaign.methods
        .createRequest( web3.utils.toWei(value, 'ether'), recipient)
